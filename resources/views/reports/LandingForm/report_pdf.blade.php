    ...
    <table width="100%">
        <tr>
            <td width="100%" class="text-center">
                <span class="title">REPORTE DE SUSCRITOS</span> <br>
            </td>
        </tr>
    </table>
    <hr />
    @if (count($reports) > 0)
            <div>
                <table class="full-width mt-10 mb-10">
                    <thead class="">
                        <tr>
                            <th class="border-top-bottom desc-9 text-left" width="30%">Cliente</th>
                            <th class="border-top-bottom desc-9 text-left" width="30%">E-mail</th>
