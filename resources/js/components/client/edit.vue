                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Codigo" placeholder="Codigo" v-model="record.code" @keyup.enter="setEditarPermiso">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Dirección" placeholder="Dirección" v-model="record.address" @keyup.enter="setEditarPermiso">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="Lugar">Lugar (*)</label>
                                        <input type="text" class="form-control" id="Lugar" placeholder="Lugar" v-model="record.place" @keyup.enter="setEditarPermiso">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="phone_number">Teléfono Celular (*)</label>
                                        <input type="text" class="form-control" for="phone_number" placeholder="Teléfono Celular" v-model="record.phone_number" @keyup.enter="setEditarPermiso">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
    ...
    export default {
        ...
        methods: {
            async getClienteById(){
                ...
                var url = '/operacion/cliente/show/' + this.record.id
                ...
                if (res.status == 200) {
                    ...
                    this.record.place       =   res.data.place;
                    this.record.phone_number=   res.data.phone_number;
                    this.record.tipo_id     =   res.data.tipo_id;
            ...
            async setEditarPermiso(){
                ...
                var url = '/operacion/cliente/update/' + this.record.id
