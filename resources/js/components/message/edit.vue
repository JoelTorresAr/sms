                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form @submit.prevent>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <button type="button" class="btn btn-outline-primary has-ripple" @click.prevent="setEditarMensaje" v-loading.fullscreen.lock="fullscreenLoading">Guardar</button>
    ...
    export default {
        ...
        methods: {
            async getMensajeById(){
                ...
                var url = '/configuracion/mensaje/show/' + this.record.id

                const res = await this.callApi('get', url)

                if (res.status == 200) {
                    this.record.message    =   res.data.message;
            ...
            async setEditarMensaje(){
                if (this.validarEditarMensaje()) {
                    return;
                }
                this.fullscreenLoading = true;

                var url = '/configuracion/mensaje/update/' + this.record.id
