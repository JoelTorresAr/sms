                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form @submit.prevent>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Nombre" placeholder="Nombre" v-model="record.name" @keyup.enter="setRegistrarRol">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="Url">Url Amigable (*)</label>
                                        <input type="text" class="form-control" for="Url" placeholder="Url Amigable" v-model="record.slug" @keyup.enter="setRegistrarRol">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <button type="button" class="btn btn-outline-primary has-ripple" @click.prevent="setRegistrarRol" v-loading.fullscreen.lock="fullscreenLoading">Guardar</button>
...
<script>
    export default {
        ...
        methods: {
            ...
            async setRegistrarRol(){
                if (this.validarRegistrarPermiso()) {
                    return;
                }
                this.fullscreenLoading = true;

                var url = '/seguridad/rol/store'
